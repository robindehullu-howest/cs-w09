...
public class GetAttendeeByIdTrigger
{
    [FunctionName("GetAttendeeByIdTrigger")]
    public async Task<IActionResult> GetAttendeeById(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "attendee/{id}")] HttpRequest req, string id,
        ILogger log)
    {
